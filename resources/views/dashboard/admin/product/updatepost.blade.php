...
@section('hierarchy')
    ...
    <x-breadcrumb-item title="ویرایش محصول" route="dashboard.admin.news.updatepost" />
@endsection
@section('content')
    @if(Session::has('info'))
    <div class="row">
...
@endif
    <div class="col-md-12">
        ...
        <form action="{{ route('dashboard.admin.product.updateproduct', $post->id) }}" method="post" role="form" class="form-horizontal " enctype="multipart/form-data">
