...
<x-sidebar-item title="لیست دسته‌بندی‌ها" icon="fas fa-folder" route="dashboard.admin.categories.index" />
<x-sidebar-item title="افزودن دسته‌بندی" icon="fas fa-plus" route="dashboard.admin.categories.create" />
