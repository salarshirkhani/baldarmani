...
(function ($) {
    ...
    window.myMap = function () {
        ...
        var marker = new google.maps.Marker({
			...
			icon: template_dir+'img/map-marker.png'
        });
...
jQuery(document).ready(function($){
  $("#contactForm").submit(function(){
        ...
        if(idLanguage==1){
          ...
          txtInvio="Enviando...";
          txtSuccess="Solicitud enviada!";
          txtError="Error, verifique los datos e intente nuevamente.";
          txtErrorObblig="Debes completar los datos obligatorios.";
          txtErrorPrivacy="Debes aceptar la privacidad.";
        }else if(idLanguage==5){

          txtInvio="Отправка...";
          txtSuccess="Запрос отправлен!";
          txtError="Ошибка, проверьте данные и попробуйте снова.";
          txtErrorObblig="Вы должны заполнить обязательные данные.";
          txtErrorPrivacy="Вы должны принять конфиденциальность.";
        }
        ...
        if($('#privacy').prop('checked')){
          ...
          $.ajax({  
              type: "POST",
              url: 'https://www.leadermedica.com/',
            ...
            beforeSend: function() {
              ...
              success: function(response){
                $('#loadResult').html('<div class="alert alert-success"><b>'+txtSuccess+'</b></div><script>$("#richiesta_web").val("");$("#ragione_sociale").val("");$("#cellulare").val("");$("#email").val("");</script>');
